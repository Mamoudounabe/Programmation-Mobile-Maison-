...
class HouseDevicesActivity : AppCompatActivity() {
    ...
    fun onButtonGarageClic(view: View) {
        val intent = Intent(this, HouseDevicesGarageActivity::class.java)
    ...
    fun onButtonLightsClic(view: View) {
        val intent = Intent(this, HouseDevicesLumiereActivity::class.java)
        intent.putExtra("HOUSE_ID", houseId)
        intent.putExtra("TOKEN", token)
        startActivity(intent)
    }
    ...
    fun onButtonShuttersClic(view: View) {
        val intent = Intent(this, HouseDevicesVoletActivity::class.java)
        intent.putExtra("HOUSE_ID", houseId)
        intent.putExtra("TOKEN", token)
        startActivity(intent)
    }
     ...
     */
    private fun sendCommand(device: Device, command: String) {
